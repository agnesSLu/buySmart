          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-5">
            <aside>
              ...
              <div className="space-x-2 overflow-auto text-center whitespace-nowrap">
                {product?.images?.map((img) => (
                  <a
                    className="inline-block border border-gray-200 p-1 rounded-md hover:border-red-800 cursor-pointer"
            ...
            <main>
              ...
              <div className="flex flex-wrap gap-2 mb-5">
                <button
                  className="px-4 py-2 inline-block text-white bg-green-300 border border-transparent rounded-md hover:bg-green-500"
